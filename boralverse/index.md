...
layout: page
title: Boralverse
permalink: /boralverse/
description: An alternate-history setting built around the Borlish language
---
...
- [Borlish Dictionary](/boralverse/borlish-dictionary/) — search the lexicon, browse by letter, filter by part of speech.
- [Boralverse Wiki](/boralverse/wiki/) — an encyclopaedia of the setting, including reference articles on Borlish orthography, phonology, morphology, and sound changes from Vulgar Latin.
- [Tumblr](https://tumblr.com/jackhkeynes) — my external Tumblr blog, where most Boralverse worldbuilding posts originate.

<div id="wotd" class="wotd" data-fetch-url="{{ '/assets/boralverse/borlish-dictionary.json' | relative_url }}" data-dict-url="{{ '/boralverse/borlish-dictionary/' | relative_url }}">
  <h2 class="wotd-heading">Word of the Day</h2>
  <div id="wotd-body" class="wotd-body">
    <p class="wotd-loading">Loading…</p>
  </div>
</div>

<script src="{{ '/assets/js/word-of-day.js' | relative_url }}"></script>
